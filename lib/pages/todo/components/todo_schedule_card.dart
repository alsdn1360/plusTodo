...
class TodoScheduleCard extends ConsumerWidget {
  const TodoScheduleCard({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final todoData = ref.watch(todoListProvider);
    final scheduleData = todoData.where((todoData) => todoData.urgency < 5 && todoData.importance >= 5).toList();
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              final todoList = scheduleData[index];
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: CustomTextStyle.caption2.copyWith(color: orange),
                      ),
                    ],
                  ),
                ],
